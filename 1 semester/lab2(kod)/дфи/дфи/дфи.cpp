...
start:
	...
	case 2:
	{
		...
		vector <int> D; //создаем множество дф
		int i, j;
	...
	case 6: {
		...
		int x = -30; //присваиваем х значение 1
		while (x <= 30) { //проверяем больше ли х двухсот
	...
	case 7: {
		...
		int x = -30;//присваиваем х значение 1
		while (x <= 30) { //проверяем больше ли х 200
			U.push_back(x); //добавляем х в универсум
			x++;//увеличиваем х на 1
		}
		int sch = 0;
